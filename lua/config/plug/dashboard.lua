...
g.dashboard_custom_section = {
	...
	d = { description = { 'ﱐ  New File             <leader>fn     ' }, command = 'DashboardNewFile' },
	e = { description = { '  Bookmarks            <leader>fm     ' }, command = 'Telescope marks' },
	f = { description = { '  Open Help Doc        <leader>fh     ' }, command = 'view ~/.config/nvim/doc/helpdoc.md' },
}
